					...
					<div class="about-content">
						<div class="about-content-text">
							...
							<div class="about-btn-box"> 
								<a class="default-btn project-btn-1" href="{{ route('services') }}">Learn More<span></span></a>
							</div>
						</div>
					</div>
				</div>
